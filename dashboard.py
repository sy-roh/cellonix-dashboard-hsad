...
# 비밀번호가 틀리면 여기서 코드 실행을 멈춤 (아래 대시보드 내용을 안 보여줌)
...
def load_data():
    # [수정포인트 1] 새로운 파일명 적용 및 공식몰전체 데이터 추가
...
# [수정포인트 3] 필터 로직 변경: 선택한 브랜드에 해당하는 데이터만 정확히 필터링 ('전체' 엑셀 활용)
